    ...
    const postData = async () => {
      ...
      try {
        ...
        if (dataForBreakdown.shouldDoPostReq === true) {
          ...
          const student: any = JSON.parse(localStorage.getItem("user"))?.studentId;
          setStudentId(student);
          console.log("StudentId api call: ", student);
          const url2 = `${process.env.NEXT_PUBLIC_BACKEND_1_SERVER_URL}/planner/getStudentSchedule/${wbStrId}/${student}`;
