...
export default function StudentDetail({studentId, onBack}: StudentDetailProps) {
  ...
  const handleUpdateStudent = (updatedStudent: StudentDetail) => {
  ...
  return (
    <div className="bg-white shadow rounded-lg">
      ...
      <div
        ...
        <div className="flex space-x-2 w-full justify-between sm:w-fit items-center">
          <button
          ...
          {/*  <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p
                  className="text-lg font-semibold text-gray-900">{student.user.isVerified ? 'Verified' : 'Pending'}</p>
              </div>
            </div>
          </div>*/}
          <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p
                  className="text-lg font-semibold text-gray-900">{formatDate(student.user.createdAt).split('/')[2] || 'N/A'}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div>
              <div
                ...
                <button
                  ...
                  className="px-3 w-full md:w-fit py-1 text-sm font-medium text-gray-700 bg-gray-100 border border-gray-200 rounded-md hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors"
                >
                  Enroll Student
                </button>
              </div>

              <div className="bg-gray-50 md:p-4 rounded-md space-y-3">
                  ...
                  <div className="space-y-4">
                    {student.classEnrollments.map((enrollment, index) => (
                      <div key={enrollment.id}
                        ...
                        <div className="flex flex-col sm:flex-row sm:justify-between items-start mb-3 gap-y-3">
                          <div className="flex items-center">
                            <div
                          ...
                          <div className={"flex w-full md:w-fit justify-between items-center space-x-2"}>
                            <button
                              className="px-3 py-1 text-xs font-medium rounded-full text-red-700 bg-red-100 border border-red-200  hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200"
                              onClick={() => {
