      ...
      <div className="w-full">
            ...
            <div className="flex flex-col lg:flex-row items-start gap-6">
              <div className="flex flex-col sm:flex-row items-start gap-4 w-full">
                ...
                <div className="flex-1 min-w-0">
                  <h2
                    className="text-lg md:text-2xl font-bold text-indigo-700 mb-2 break-words">{instituteData?.name}</h2>
                  <div className="text-sm text-gray-600 space-y-1">
                    <p
                      className="break-words">Address: {instituteData.city}, {instituteData.state}, {instituteData.country}</p>
        ...
        <div className="bg-white rounded-lg shadow-sm mb-6 md:max-w-[calc(100vw-370px)] mx-auto">
          ...
          <div className="overflow-x-auto">
            <table className="w-full" style={{minWidth: '1100px'}}>
              ...
              <tr>
                <th
                  className="px-4 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Name
                  & Description
                </th>
                <th
                  className="px-4 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">Total
                  Amount
                </th>
                <th
                  className="px-4 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">Tax
                  (Included)
                </th>
                <th
                  className="px-4 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">Penalty
                </th>
                <th
                  className="px-4 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">Amount
                  Due
                </th>
                <th
                  className="px-4 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">Amount
                ...
                <th
                  className="px-4 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">Due
                  Date
                </th>
                <th
                  className="px-4 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">Status
                </th>
                <th
                  className="px-4 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">Fee
                  Type
                </th>
                <th
                  className="px-4 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">Transaction
                  ID
                </th>
              </tr>
              </thead>
              ...
              {filteredFees.length === 0 ? (
                ...
                filteredFees.map((fee) => (
                  <tr key={fee.id} className="hover:bg-gray-50">
                    ...
                    <td
                      className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">₹{fee.baseAmount.toFixed(2)}</td>
                    ...
                    <td
                      className="px-6 py-4 whitespace-nowrap text-sm font-medium text-indigo-600">₹{fee.amountDue.toFixed(2)}</td>
                    <td
                      className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">₹{(fee.amountPaid || 0).toFixed(2)}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      {new Date(fee.dueDate).toLocaleDateString('en-IN')}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                                                <span
                                                  className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${fee.status === 'PAID'
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                                                <span
                                                  className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${fee.feeType === 'Global'
        ...
        <div className="bg-white rounded-lg shadow-sm w-fit mx-auto">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-xl font-semibold text-indigo-700">{instituteData?.name || 'XYZ Institution'} Payment
              Details</h2>
          </div>
          <div className="p-6">
            <div className="flex gap-8">
              ...
              <div className="flex-shrink-0">
                <div
                  className="w-48 h-48 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center">
              ...
              <div className="flex justify-center">
                <div className="flex flex-col">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-indigo-600 mb-1">Bank Name and Branch
                        Location:</label>
                      <input
                        type="text"
