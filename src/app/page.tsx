      ...
      <header className="bg-white shadow">
        <div className="max-w-screen mx-auto px-6 py-4 flex justify-between items-center">
          {/*<Image
                    ...
                    />*/}
          <div className="object-contain glow-button px-6 py-2 rounded-lg text-base font-semibold cursor-pointer relative overflow-hidden transition-all duration-300 ease-in-out hover:scale-105">
            Institute ERP Portal
          </div>
          {/* Desktop Nav */}
          <nav className="hidden md:flex items-center gap-6">
            ...
            <div className="relative group inline-block">
              ...
              <div className="absolute top-[calc(100%+8px)] left-1/2 transform -translate-x-1/2 mt-2 px-3 py-1.5 bg-gray-800 text-white text-xs rounded-md shadow-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-all duration-300 ease-in-out pointer-events-none group-hover:scale-100 scale-95 origin-top">
                For Individuals
                <svg
                  className="absolute text-gray-800 h-2 w-full left-0 top-[-7px]"
                  x="0px"
                  y="0px"
                  viewBox="0 0 255 255"
                  xmlSpace="preserve"
            ...
            >
              ...
              {/* Changed to UserPlus icon for Register */}
              Register
            </Link>
          </nav>
          {/* Mobile Menu Toggle */}
            ...
            <div className="w-64 bg-white h-full shadow-xl p-6">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex justify-center mt-2">
                  {" "}
                  {/* Added margin-top for spacing from buttons above */}
                  <div className="relative group inline-block">
                    <button
                      onClick={() => {
          ...
          <div className="relative container mx-auto flex px-2 md:px-6 py-6 sm:py-32 z-10 md:ml-24">
            <div className="max-w-2xl text-left">
              <div className="flex flex-col items-start gap-2">
                ...
                <h1 className="text-5xl md:text-7xl font-bold text-[#3A1078]">
                  Classrooms
                </h1>
                <h3 className="text-3xl md:text-5xl font-medium text-gray-800">
                  Smart{" "}
                  <span className="text-[#3A1078] font-bold">Futures</span>
                </h3>
              </div>

              <p className="mt-8 text-lg text-gray-600 max-w-lg">
                Transform the way you learn and teach with AI-powered tools that
              ...
              <button
                className="mt-12 bg-purple-900 hover:bg-purple-800 text-white font-bold text-xl py-4 px-20 md:px-36 rounded-lg transition-colors shadow-lg hover:shadow-xl"
      ...
      <div className="hidden  md:flex">
        <div className="relative left-32 -top-28">
          <img
            src="/home_line.png"
            alt="Hero"
            className="w-[416px] h-auto object-cover"
          />
        </div>
          ...
          <div className="container mx-auto max-w-7xl px-6 py-16 md:py-24">
            ...
            <div className="max-w-5xl">
              ...
              <p className="mt-4 md:mt-6 text-lg md:text-xl text-gray-600 max-w-3xl">
                ...
                Celebrated for smoothness. Welcome to the ERP platform
                institutions love.
              </p>
              ...
              <div className="mt-8 md:mt-10 flex flex-col lg:flex-row items-center gap-x-6 gap-y-4">
                ...
                <div className="w-full lg:w-auto">
                  <button
                    className="w-full lg:w-auto whitespace-nowrap rounded-md border border-[#c5b3e5] px-6 py-3 font-semibold text-[#6f42c1] transition-colors hover:bg-[#f3e5f5] hover:border-[#6f42c1]"
            ...
            <div className="mt-20 md:mt-32 max-w-5xl">
              <h2 className="text-4xl font-normal font-[Helvetica]">
                <span className="text-[#4a0e6c]">Accelerate high-quality </span>
                <span className="text-[#a38fc9]">
                  Institution Management development. Our platform drives
                  innovation with tools that boost management velocity.
                </span>
              </h2>
            </div>
          </div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center">
              ...
              <div className="flex-1">
                <h2 className="text-[28px] font-normal font-[Helvetica]">
                  ...
                  <span className="text-[#a38fc9]">
                    offers a complete ERP platform, so you can control, manage,
                    structure, and access from any part and from anywhere.
                  </span>
                </h2>
              </div>
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col justify-center align-middle items-center flex-1 max-h-36 relative top-96 md:top-40">
                  <img
                    src="/PortsView.png"
                    alt="AI-Classroom Workspaces"
                    className="relative -top-72 md:-top-0"
                  />
                  <img
                    src="/ActionsMenu.png"
                    alt="AI-Classroom Workspaces Actions Menu"
                    className="hidden md:block relative z-10 -top-96 left-36"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="flex justify-center mt-2 px-4 mb:px-16 top-50">
            ...
            <div className="max-w-3xl p-0 pb-20 md:p-20 mt-24">
              ...
              <div className="inline-block relative">
                <h2 className="text-sm font-bold tracking-[.2em] text-purple-400">
                  ABOUT US
                </h2>
              ...
              <p className="text-md text-gray-600 leading-relaxed">
                We are more than just an educational platform. AI Classroom
                revolutionizes the way institutions manage their academic
                operations through intelligent automation, seamless integration,
                and data-driven insights. Our comprehensive ERP solution
                empowers administrators, teachers, and students to achieve
          ...
          <div className="py-2 md:py-20 bg-[url(/qwqw.png)] ">
            ...
            <div className="font-sans w-full py-20 px-10">
              <div className="container mx-auto text-center">
                {/* Heading */}
                <p className="tracking-wider text-sm text-white mb-2">
                  HEADING 1
                </p>
